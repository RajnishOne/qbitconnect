    ...
    return Consumer<BatchSelectionState>(
      builder: (context, batchState, child) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (batchState.hasSelection && !_animationController.isCompleted) {
          ...
          builder: (context, child) {
            return Transform.translate(
              ...
              child: Transform.scale(
                ...
                child: _buildActionsBar(context, batchState),
              ),
            );
          },
        );
  ...
  Future<void> _performBatchOperation(
    ...
    try {
      ...
      if (result.success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(result.errorMessage ?? 'Operation failed'),
  ...
  Future<void> _performDeleteOperation(
    ...
    try {
      ...
      if (result.success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(result.errorMessage ?? 'Delete operation failed'),
            backgroundColor: Colors.red,
          ),
        );
      }
