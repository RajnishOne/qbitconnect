class QbittorrentEndpoints {
  ...
  static const String appPreferences = '$_basePath/app/preferences';
  static const String appDefaultSavePath = '$_basePath/app/defaultSavePath';
  static const String appBuildInfo = '$_basePath/app/buildInfo';

  // Transfer endpoints
  static const String transferInfo = '$_basePath/transfer/info';

  // Sync endpoints
  static const String syncMainData = '$_basePath/sync/maindata';
  static const String syncTorrentPeers = '$_basePath/sync/torrentPeers';
