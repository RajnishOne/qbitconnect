...
class TorrentDetails {
  ...
  factory TorrentDetails.fromMap(Map<String, dynamic> map) {
    return TorrentDetails(
      ...
      additionDate: (map['addition_date'] ?? '').toString(),
  ...
  String get formattedSize => _formatBytes(totalDownloaded);
  String get formattedUploaded => _formatBytes(totalUploaded);
  String get formattedWasted => _formatBytes(totalWasted);
  String get formattedDlSpeed => '${_formatBytes(dlSpeed)}/s';
  String get formattedUpSpeed => '${_formatBytes(upSpeed)}/s';
  String get formattedDlSpeedAvg => '${_formatBytes(dlSpeedAvg)}/s';
  String get formattedUpSpeedAvg => '${_formatBytes(upSpeedAvg)}/s';
  ...
  String get formattedPieceSize => _formatBytes(pieceSize);
...
class TorrentFile {
  ...
  String get formattedSize => TorrentDetails._formatBytes(size);
