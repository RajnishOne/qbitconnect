                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: previewColors[0].withValues(
                                    alpha: 0.8,
                                  ),
                                ...
                                child: Center(
                                  child: Icon(
                                    Icons.palette,
                                    color:
                                        previewColors[0].computeLuminance() >
                                            0.5
                                        ? Colors.black
                                        : Colors.white,
                                    size: 20,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: previewColors[1].withValues(
                                    alpha: 0.8,
                                  ),
                                ),
                                child: Center(
                                  child: Icon(
                                    Icons.ac_unit,
                                    color:
                                        previewColors[1].computeLuminance() >
                                            0.5
                                        ? Colors.black
                                        : Colors.white,
                                    size: 16,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: previewColors[2].withValues(
                                    alpha: 0.8,
                                  ),
                                ),
                                child: Center(
                                  child: Icon(
                                    Icons.circle,
                                    color:
                                        previewColors[2].computeLuminance() >
                                            0.5
                                        ? Colors.black
                                        : Colors.white,
                                    size: 12,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: previewColors[3].withValues(
                                    alpha: 0.8,
                                  ),
                                  borderRadius: const BorderRadius.only(
                                ...
                                child: Center(
                                  child: Icon(
                                    ...
                                    color:
                                        previewColors[3].computeLuminance() >
                                            0.5
                                        ? Colors.black
                                        : Colors.white,
                                    size: 14,
