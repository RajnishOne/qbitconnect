...
class AppThemeVariant {
  ...
  static const AppThemeVariant system = AppThemeVariant(
    name: 'system',
    displayName: 'System',
...
AppColorScheme _systemColorScheme({required bool isDarkMode}) {
  // System theme uses the same colors as light/dark but adapts based on system brightness
  if (isDarkMode) {
    return _darkColorScheme(isDarkMode: isDarkMode);
  } else {
